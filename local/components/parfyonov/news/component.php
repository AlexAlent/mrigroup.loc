...
if($arParams["SEF_MODE"] == "Y")
{
    ...
    if($bTestSef) {
        if($componentPage == 'section' && !isset($arVariables['SECTION_ID'])) {
            ...
            if(!$res->fetch()) {
                $sefUrlTemplates = $arParams['SEF_URL_TEMPLATES'];
                $sefUrlTemplates['section'] = '';
                $sefUrlTemplates['detail'] = '#ELEMENT_CODE#/';
                $arUrlTemplates = CComponentEngine::makeComponentUrlTemplates($arDefaultUrlTemplates404, $sefUrlTemplates);
