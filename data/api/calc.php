...
if(isset($_REQUEST['product_id']) && isset($_REQUEST['researches']) && isset($_REQUEST['workdays']) && isset($_REQUEST['research_price'])) {
    ...
    if(!is_array($arProduct) || $arProduct['IBLOCK_ID'] != 9) {
        ...
        if($price) {
            ...
            $researchPrice = intval($_REQUEST['research_price']);
    ...
    <?php if(!$error):
        ...
        <div class="modal-body">
            ...
            <div class="modal-button">
                <a href="/data/api/feedback.php?<?php echo http_build_query($feedbackRequest);?>" class="btn btn-outline-primary link-modal">
