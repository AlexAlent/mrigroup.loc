    ...
    (function (t) {
        ...
        class o {
            ...
            initialize() {
                ...
                this.$form.on("submit", {validator: e}, this.handleSubmit), this.$form.on("custom:start", this.handleCustomStart), this.$form.on("custom:stop", this.handleCustomStop), t.each(this.$form.find('input[type="tel"]'), (e, i) => {
                    const n = t(i);
                    n.on("blur.mask", e => {
                        t(e.currentTarget).trigger("change")
                    }), n.mask("+7 (999) 999-99-99", {autoclear: !1}), n.rules("add", {phoneRU: !0})
                }), t.each(this.$form.find(".single-range"), (t, e) => {
                    new s.a(e)
                }), t.each(this.$form.find(".time-range"), (t, e) => {
                    new a.a(e)
                })
            }
        }
