...
$products = [];
if(isset($arResult['PROPERTIES']['TOVARY']) && $arResult['PROPERTIES']['TOVARY']['VALUE']) {
    $products = is_array($arResult['PROPERTIES']['TOVARY']['VALUE']) ? $arResult['PROPERTIES']['TOVARY']['VALUE'] : [$arResult['PROPERTIES']['TOVARY']['VALUE']];
}
?>
<div class="section">
    <div class="container">
