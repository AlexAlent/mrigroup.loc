...
<div class="section main-hero">
    <div class="container">
        <div class="main-hero-slider-wrap main-hero-slider-wrap-new">
            <div class="main-hero-slider swiper">
                <?php foreach($arResult["ITEMS"] as $arItem):
                    $this->AddEditAction($arItem['ID'], $arItem['EDIT_LINK'], CIBlock::GetArrayByID($arItem["IBLOCK_ID"], "ELEMENT_EDIT"));
                    $this->AddDeleteAction($arItem['ID'], $arItem['DELETE_LINK'], CIBlock::GetArrayByID($arItem["IBLOCK_ID"], "ELEMENT_DELETE"), array("CONFIRM" => GetMessage('CT_BNL_ELEMENT_DELETE_CONFIRM')));
                    $linkHref = isset($arItem['PROPERTIES']['LINK_HREF']) ? trim($arItem['PROPERTIES']['LINK_HREF']['VALUE']) : '';
                    $linkText = isset($arItem['PROPERTIES']['LINK_TEXT']) ? trim($arItem['PROPERTIES']['LINK_TEXT']['VALUE']) : '';
                    ?>
                                        ...
                                        <div class="main-hero-slider-item__content-wrap">
                                            ...
                                            <?php if ($linkText && $linkHref):?>
                                                <div class="main-hero-slider-item__button">
                                                    <a href="<?php echo $linkHref;?>" class="btn btn-primary">
            ...
            <div class="swiper-navigation">
                ...
                <button class="swiper-button-next">
                    ...
                    <svg class="progress" width="53" height="53"><circle class="circle-origin" r="23.5" cx="26.5" cy="26.5"></circle></svg>
                </button>
            </div>
        </div>
    </div>
