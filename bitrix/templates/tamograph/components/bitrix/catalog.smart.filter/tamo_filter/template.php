...
<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="
    <?echo $arResult["FORM_ACTION"]?>" method="get" class="catalog-filter-form" autocomplete="off">
    ...
    <div class="catalog-filter-body">
        <div class="catalog-filter-list">
            <div class="catalog-filter-item">
                <a href="#collapse-0" role="button" class="catalog-filter-toggle" data-toggle="collapse"
                    aria-expanded="true">
                    <span>Сортировка</span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M5.97 10.28l1.06-1.06L13 15.19l5.97-5.97 1.06 1.06L13 17.31l-7.03-7.03z" />
                    </svg>
                </a>

            </div>
            <div id="collapse-0" class="catalog-filter-collapse collapse show">
                <div class="list-group">
                    <div class="list-group-item">
                        <div class="form-radio">
                            <label class="form-radio-label">
                                <input type="radio" name="filter[props1][]" checked />
                    ...
                    <div class="list-group-item">
                        <div class="form-radio">
                            <label class="form-radio-label">
                                <input type="radio" name="filter[props1][]" />
                                <span class="form-radio-icon"></span>
                                <span class="form-radio-text">
                                    по возрастанию цены
                                </span>
        ...
        <?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
				{
					...
					if(isset($arItem["PRICE"])):
						...
						?>
        <a href="#collapse-<?=$i-1?>" role="button" class="catalog-filter-toggle" data-toggle="collapse"
            aria-expanded="true">
        ...
        <div id="collapse-<?=$i-1?>" class="catalog-filter-collapse collapse show" data-role="bx_filter_block">
            <div class="list-group">
                <div class="list-group-item">
                    <?//if($USER->IsAdmin()) {echo '<pre>'; print_r($arItem["VALUES"]); echo '</pre>';}; ?>
                    <div class="form-range double-range">
                        <input type="text" name="<?=$arItem["VALUES"]["MIN"]["CONTROL_NAME"]?>"
                            value="<?=$arItem["VALUES"]["MIN"]["HTML_VALUE"]?>"
                            class="form-range-input input-from form-control" />
                        <input type="text" name="<?=$arItem["VALUES"]["MAX"]["CONTROL_NAME"]?>"
                            value="<?=$arItem["VALUES"]["MAX"]["HTML_VALUE"]?>"
                            class="form-range-input input-to form-control" />
                        <div class="form-range-slider input-slider" data-min="<?=$arItem["VALUES"]["MIN"]["VALUE"]?>"
                            data-max="<?=$arItem["VALUES"]["MAX"]["VALUE"]?>"
                            data-start="<?=$arItem["VALUES"]["MIN"]["HTML_VALUE"]?>" data-end="<?if (!empty($arItem["
                            VALUES"]["MAX"]["HTML_VALUE"])){echo $arItem["VALUES"]["MAX"]["HTML_VALUE"];} else {echo
                            $arItem["VALUES"]["MAX"]["VALUE"];}?>"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="smart-filter-parameters-box-container">
            <?
							...
							switch ($arItem["DISPLAY_TYPE"])
							{
								...
								?>
            <a href="#collapse-<?=$i?>" role="button" class="catalog-filter-toggle" data-toggle="collapse"
                aria-expanded="true">
                <span><?=$arItem["NAME"]?></span>
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26">
                    <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div id="collapse-<?=$i?>" class="catalog-filter-collapse collapse show">

                <div class="list-group">
                    <div class="list-group-item">
                        <div class="form-range double-range">
                            <input class="form-range-input input-from form-control" type="number" name="<?echo $arItem["
                                VALUES"]["MIN"]["CONTROL_NAME"]?>"
                            id="
                            ...
                            />
                            <input class="form-range-input input-to form-control" type="number" name="<?echo $arItem["
                                VALUES"]["MAX"]["CONTROL_NAME"]?>"
                            id="
                            ...
                            <div class="form-range-slider input-slider"
                                ...
                                data-max="<?=$arItem["VALUES"]["MAX"]["VALUE"]?>"
                                data-start="<?=$arItem["VALUES"]["MIN"]["HTML_VALUE"]?>"
                                data-end="<?if (!empty($arItem["VALUES"]["MAX"]["HTML_VALUE"])){echo
                                $arItem["VALUES"]["MAX"]["HTML_VALUE"];} else {echo
                                $arItem["VALUES"]["MAX"]["VALUE"];}?>"></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between">
                    <div class="form-group" style="width: calc(50% - 10px);">
                        <div class="smart-filter-input-container">
                            <input class="min-price form-control form-control-sm" type="number" name="<?echo $arItem["
                                VALUES"]["MIN"]["CONTROL_NAME"]?>"
                            id="
                            <?echo $arItem["VALUES"]["MIN"]["CONTROL_ID"]?>"
                            value="
                    ...
                    <div class="form-group" style="width: calc(50% - 10px);">
                        <div class="smart-filter-input-container">
                            <input class="max-price form-control form-control-sm" type="number" name="<?echo $arItem["
                                VALUES"]["MAX"]["CONTROL_NAME"]?>"
                            id="
                            <?echo $arItem["VALUES"]["MAX"]["CONTROL_ID"]?>"
                            value="
            ...
            <div class="smart-filter-input-group-checkbox-pictures">
                ...
                <input style="display: none" type="checkbox" name="<?=$ar["CONTROL_NAME"]?>" id="<?=$ar["CONTROL_ID"]?>"
                    value="<?=$ar["HTML_VALUE"]?>" <? echo $ar["CHECKED"]? 'checked' : '' ?>
                />
                <?
												$class = "";
												if ($ar["CHECKED"])
            ...
            <div class="smart-filter-input-group-dropdown">
                <div class="smart-filter-dropdown-block"
                    ...
                    <div class="smart-filter-dropdown-popup" data-role="dropdownContent" style="display: none;">
                        <ul>
                            <li>
                                <label for="<?="all_".$arCur["CONTROL_ID"]?>" class="smart-filter-dropdown-label"
                            ...
                            <?foreach ($arItem["VALUES"] as $val => $ar):
													...
													?>
                            <li>
                                <label for="<?=$ar["CONTROL_ID"]?>" class="smart-filter-dropdown-label<?=$class?>"
            ...
            <div class="smart-filter-input-group-dropdown">
                <div class="smart-filter-dropdown-block"
                    ...
                    <?foreach ($arItem["VALUES"] as $val => $ar):?>
                    <input style="display: none" type="radio" name="<?=$ar["CONTROL_NAME_ALT"]?>"
                        id="<?=$ar["CONTROL_ID"]?>" value="<?=$ar["HTML_VALUE_ALT"]?>" <? echo $ar["CHECKED"]? 'checked'
                        : '' ?>
                    />
                    <?endforeach?>
                    ...
                    <div class="smart-filter-dropdown-popup" data-role="dropdownContent" style="display: none">
                        <ul>
                            <li style="border-bottom: 1px solid #e5e5e5;padding-bottom: 5px;margin-bottom: 5px;">
                                <label for="<?="all_".$arCur["CONTROL_ID"]?>" class="smart-filter-param-label"
                                    data-role="label_<?="all_".$arCur["CONTROL_ID"]?>"
                                    onclick="smartFilter.selectDropDownItem(this, '<?=CUtil::JSEscape("all_".$arCur["CONTROL_ID"])?>')">
                                    <span class="smart-filter-checkbox-btn-image all"></span>
                                    <span
                                        class="smart-filter-dropdown-text"><?=GetMessage("CT_BCSF_FILTER_ALL"); ?></span>
                                </label>
                            </li>
                            <?
													foreach ($arItem["VALUES"] as $val => $ar):
            ...
            <div class="col">
                <div class="radio">
                    <label class="smart-filter-param-label" for="<? echo " all_".$arCur["CONTROL_ID"] ?>">
                        <span class="smart-filter-input-checkbox">
                            <input type="radio" value="" name="<? echo $arCur["CONTROL_NAME_ALT"] ?>"
                            id="
                ...
                <div class="radio">
                    ...
                    <label data-role="label_<?=$ar["CONTROL_ID"]?>" class="smart-filter-param-label" for="<? echo $ar["
                        CONTROL_ID"] ?>">
            ...
            <?
								...
								default:
									?>
            <div class="catalog-filter-item">
                <a href="#collapse-<?=$ii?>" role="button" class="catalog-filter-toggle" data-toggle="collapse"
                    aria-expanded="true">
                    <span>
                        <? echo $arItem["NAME"] ?>
                    </span>
                ...
                <div id="collapse-<?=$ii?>" class="catalog-filter-collapse collapse show">
                    <div class="list-group">

                        <?foreach($arItem["VALUES"] as $val => $ar):?>
                        <div class="list-group-item">
                            <div class="form-check">
                                <? //if($USER->IsAdmin()) {echo '<pre>'; print_r($ar); echo '</pre>';}; ?>
    ...
    <div class="popover popover-right" role="tooltip" style="position: absolute; top: 254px; left: 100%;" id="modef">
    ...
    <div class="catalog-filter-foot">
        <input class="btn btn-primary" type="submit" id="modef_num set_filter" name="set_filter"
            value="<?=GetMessage("CT_BCSF_SET_FILTER")?>" />
        <input class="btn btn-secondary" type="submit" id="del_filter" name="del_filter"
