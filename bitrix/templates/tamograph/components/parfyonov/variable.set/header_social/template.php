...
<ul class="topbar-social social nav">
    ...
    <?php if($vk):?>
        <li class="nav-item">
            <a href="<?php echo $vk;?>" class="nav-link" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                    <path d="M10.815 15.585c-5.74 0-9.015-3.935-9.15-10.483h2.874c.095 4.806 2.215 6.842 3.894 7.261v-7.26h2.707v4.145c1.658-.179 3.4-2.068 3.988-4.145h2.707c-.45 2.56-2.34 4.45-3.683 5.226 1.343.63 3.495 2.277 4.313 5.257h-2.98c-.64-1.994-2.235-3.536-4.345-3.746v3.746h-.325z" />
                </svg>
            </a>
        </li>
    <?php endif;?>
    <?php if($ok):?>
        <li class="nav-item">
            <a href="<?php echo tplvar(MrigroupHelper::tplvar_index_social_ok);?>" class="nav-link" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
